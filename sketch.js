...
function setup(){
  ...
  colisao_solo = createSprite(width/2,height - 100,width ,15);
  colisao_solo.visible=false;

  solo = createSprite(width/2,height - 110,600,20);
...
function draw(){
  ...
  fill('black');
  textSize(20);
  text('pontos:'+ pontos,width/2-50,20);
...
function nuvens(){
  ...
  if (frameCount%70===0){
    ...
    nuvem = createSprite(width,80,10,10);
    nuvem.y = Math.round(random(height-250,height-500));
